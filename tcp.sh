...
sh_ver="1.3.2" 
github="raw.githubusercontent.com/ProxyPanel/Linux-NetSpeed/main"
...
start_menu(){
clear
echo && echo -e " TCP加速 一键安装管理脚本 ProxyPanel改版 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  -- github.com/ProxyPanel/ProxyPanel --
